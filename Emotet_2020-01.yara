...
rule Emotet_RichHash{
	...
	(hash.md5(pe.rich_signature.clear_data) == "07c4932d1fee8a2d2105a514129a5c9c" or
	 ...
	 hash.md5(pe.rich_signature.clear_data) == "e89bd0c9cfdb0e3f46cfece2915277b4" or
	 hash.md5(pe.rich_signature.clear_data) == "0e7d4f1aedb98962c4dd5c59efb91c24" or
	 hash.md5(pe.rich_signature.clear_data) == "a211d64bec2ea68e5bcc5322c1817d19" or
	 hash.md5(pe.rich_signature.clear_data) == "6481967ab241ca1e65facf849b786acc" or
	 hash.md5(pe.rich_signature.clear_data) == "7de682f07f1974e32061c24f4af1a93c" or
	 hash.md5(pe.rich_signature.clear_data) == "e3768f139adedcf8a5ac908ca044f389" or
	 hash.md5(pe.rich_signature.clear_data) == "01fcb23696754df59d888b951b68ba2a" or
	 hash.md5(pe.rich_signature.clear_data) == "7fab83580be542c8d4e920b510f2c103" or
	 hash.md5(pe.rich_signature.clear_data) == "b9dd3f0812d55f9b12708a7134dfbb26" or
	 hash.md5(pe.rich_signature.clear_data) == "46ea1706e8ea222e64680e2a2bfc4ccc" or
	 hash.md5(pe.rich_signature.clear_data) == "6498af2969ece05aa947c827450b7b20" or
	 hash.md5(pe.rich_signature.clear_data) == "747244fba8df7bbbe4819e88f84dcc17" or
	 hash.md5(pe.rich_signature.clear_data) == "9a3c90580c362e577d9721dddce855cd" or
	 hash.md5(pe.rich_signature.clear_data) == "d5783d24e4b6100ae89e0640f8840e68" or
	 hash.md5(pe.rich_signature.clear_data) == "3bf1a8f374730aaec690e7da0a9d98bc" or
	 hash.md5(pe.rich_signature.clear_data) == "de8c3ec170d78610f759561379b900f1" or
	 hash.md5(pe.rich_signature.clear_data) == "e6a6f491812d509158e27ab19ad10c08" or
	 hash.md5(pe.rich_signature.clear_data) == "7eec6c803e818d74c0533be55eb363f5")
